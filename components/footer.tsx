    ...
    <footer className="site-footer">
      <div className="container site-footer-inner">
        <div>
          ...
          <p className="muted">
            {locale === "ru"
              ? "Новости, турниры, бойцы, прогнозы и редакционное покрытие главных событий в ММА."
              : "News, events, fighters, predictions, and editorial coverage across the MMA landscape."}
          </p>
        </div>

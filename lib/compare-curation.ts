...
//
// 05.09.2026 порог на несколько часов поднимали до 15: логи nginx показали
// сотни «поисковых» заходов на пары с позициями 6–15. Оказалось, это боты с
// поддельным referer Google (467 IP, ни один не грузил статику), а по Метрике
// сравнения дают ~55 реальных заходов за две недели. Порог вернули.

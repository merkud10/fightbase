...
const articleOverrides = {
  ...
  "one-fight-night-42": {
    title: "ONE Fight Night 42: Эступинан против Ортикова и Минова против Газаряна",
    excerpt:
      "ONE Championship добавила два новых поединка в кард ONE Fight Night 42: Джордан Эступинан встретится с Асламжоном Ортиковым, а Хироба Минова — с Кареном Газаряном.",
    body:
  ...
  "one-friday-fights-148": {
    title: "Результат главного боя ONE Friday Fights 148: Конгчай победил Ханзаде",
    excerpt:
      "Конгчай Чанаидонмюанг одержал победу единогласным решением судей над Мехрдадом Ханзаде в главном бою турнира ONE Friday Fights 148 в Бангкоке.",
    body:
